...
if ($path === '/lti/launch') {
  ...
  echo '<iframe src="https://your-domain.example/types/juiste-volgorde/v1/?unique_id=COURSE123-ASSIGN456&data=https%3A%2F%2F..." width="100%" height="700"></iframe>';
  echo '</body></html>';
  exit;
}
...
if ($path === '/lti/deeplink') {
  ...
  $jwt = JWT::encode([
    ...
    'https://purl.imsglobal.org/spec/lti-dl/claim/content_items' => [[
      ...
      'custom' => [
        'launch_url' => 'https://your-domain.example/types/juiste-volgorde/v1/?unique_id=COURSE123-ASSIGN456&data=https%3A%2F%2F...'
      ]
    ]]
